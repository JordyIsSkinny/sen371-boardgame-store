...
describe('submitReview', () => {
  ...
  it('throws ForbiddenError when the user has not purchased the product', async () => {
    await expect(
      submitReview(otherUser.id, testProduct.id, 5, 'I want to review this')
